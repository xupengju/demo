...
public class DateTimeUtil {
    ...
    private static final String test1 = "04,10,16,22";
    private static final String test2 = "04,16";
...
//	}
    ...
    public static Integer getDateVersion(String str1) {
        int date = 0;
        if (null == str1) {
            return Integer.parseInt(formatDate(new Date(), YYYYMMDDHH));
        }
//        System.out.println("str1 = " + str1);
        List<String> list = Arrays.asList(str1.split(","));
//        System.out.println("list = " + list.size());
        int hour = getDateHour(new Date());
//        System.out.println("hour = " + hour);
        ...
        if (-1 == last) {
            ...
            laststr = laststr.length() == 2 ? laststr : "0" + laststr;
            date = Integer.parseInt(formatDate(addDay(new Date(), -1), YYYYMMDDS) + laststr);
        } else {
            String laststr = String.valueOf((last));
            laststr = laststr.length() == 2 ? laststr : "0" + laststr;
            date = Integer.parseInt(formatDate(new Date(), YYYYMMDDS) + laststr);
        }
        return date;
    }

    public static Integer getDateVersion(String str1, int hour) {
        int date = 0;
        if (null == str1) {
            return Integer.parseInt(formatDate(new Date(), YYYYMMDDHH));
        }
...
//
//        System.out.println("YYYYMMDDHHMMS = " + YYYYMMDDHHMMS);
//        String strDate = DateTimeUtil.formatDate(new Date(), DateTimeUtil.YYYYMMDDHHMMS);
//        strDate = strDate.substring(0, strDate.length() - 1);
//        System.out.println("YYYYMMDDHHMMS = " + strDate);
        int hour = 3;
//        System.out.println("args 00= " + getDateVersion("00,06,12,18", hour));
//        System.out.println("--------------");
//        System.out.println("args 01= " + getDateVersion("01,07,13,19", hour));
//        System.out.println("--------------");
//        System.out.println("args 02= " + getDateVersion("02,08,14,20", hour));
//        System.out.println("--------------");
//        System.out.println("args 03= " + getDateVersion("03,09,15,21", hour));
//        System.out.println("--------------");
//        System.out.println("args 04= " + getDateVersion("04,10,16,22", hour));
//        System.out.println("--------------");
//        System.out.println("args 05= " + getDateVersion("05,11,17,23", hour));

//        System.out.println(getDateVersion(test1));
        System.out.println(getDateVersion(test2));
    }
